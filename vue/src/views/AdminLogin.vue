  ...
  <div class="login-container">
    <div class="login-box">
      ...
      <el-form ref="formRef" :model="data.form" :rules="data.rules">
        ...
        <el-form-item>
          <el-button size="large" style="width: 100%; background-color: #076bdc; color: white" @click="login">登 录</el-button>
        </el-form-item>
        <div style="display: flex">
          <a style="color: #076bdc" href="/login">普通用户登录</a>
          <div style="flex: 1; text-align: right">还没有账号？请 <a style="color: #076bdc" href="/register">注册</a></div>
        </div>
      </el-form>
    </div>
  </div>
