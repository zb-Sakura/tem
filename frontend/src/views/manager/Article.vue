<template>
  <div>
    ...
    <el-dialog title="旅游攻略信息" v-model="data.formVisible" width="50%" destroy-on-close>
      <el-form ref="form" :model="data.form" label-width="70px" style="padding: 20px">
        <el-form-item prop="title" label="标题">
          <el-input v-model="data.form.title" placeholder="请输入标题"></el-input>
        </el-form-item>
        <el-form-item prop="descr" label="简介">
          <el-input :rows="5" type="textarea" v-model="data.form.descr" placeholder="请输入简介"></el-input>
        </el-form-item>
